...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    b4bd.spawn.datadir.should.equal(home + '/.b4b');
    b4bd.spawn.exec.should.equal(path.resolve(__dirname, '../../bin/b4bd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.b4bd.spawn.datadir.should.equal('./data2');
  });
});
