...
var b4bcorenode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = b4bcorenode.version;
  var create = b4bcorenode.scaffold.create;
  var add = b4bcorenode.scaffold.add;
  var start = b4bcorenode.scaffold.start;
  var remove = b4bcorenode.scaffold.remove;
  var callMethod = b4bcorenode.scaffold.callMethod;
  var findConfig = b4bcorenode.scaffold.findConfig;
  var defaultConfig = b4bcorenode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the B4bcoin database directory')
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `b4bcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ b4bcore-node add wallet-service');
      console.log('    $ b4bcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ b4bcore-node remove wallet-service');
      console.log('    $ b4bcore-node remove insight-api');
      console.log();
    });
